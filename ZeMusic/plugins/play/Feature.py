...
@app.on_message(
    filters.command(["مميزات","مميزات لورد"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس لورد إي ميوزك\n
⩹━★⊷⌯⌞ # 𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐎𝐑𝐃 ⌝⌯⊶★━⩺

★قايمه مميزات سورس لورد
            ...
            [
                [
                    InlineKeyboardButton(
                        "# 𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐎𝐑𝐃 𖠛⌝⚡", url=f"https://t.me/M_R_ZC"),                        
                 ],[
                InlineKeyboardButton(
